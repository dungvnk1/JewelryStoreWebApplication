...
public class FilterPriceServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> listP = pd.filterByPrice(minP, maxP);
        List<Category> listC = cd.getAllCategory();
        Product lastP = pd.getLast();
        session.setAttribute("listPP", listP);

        List<Product> listCP = (List<Product>) session.getAttribute("listCP");
//        if (listCP != null) {
//            for (Product cp : listCP) {
//                for (Product pp : listP) {
...
//            request.setAttribute("tagPr", minP);
