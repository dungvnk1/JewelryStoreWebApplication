...
<!--                                <td>
                ...
                <div class="alert alert-primary" style="font-size: 20px; margin-left: 60%">Tổng số tiền cần thanh toán: <b>${totalCost} $</b></div>

                <!--                <div class="alert alert-primary" style="font-size: 20px">Tổng số lượng sản phẩm: <b></b></div>
...
<!--                            <div class="form-group">
        ...
        <%
            String errorMessage = (String) request.getAttribute("errNum");
