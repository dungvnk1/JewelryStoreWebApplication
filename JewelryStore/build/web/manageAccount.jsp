...
<!--                                <td>
                                ...
                                <td>${o.address}</td>
                                <td>${o.phone}</td>
                                <td>${o.roleID == 1 ? "Admin" : "User"}</td>
                                <td>
                                    <a href="loadUser?uID=${o.userID}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="#" onclick="doDelete(${o.userID})" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
                        ...
                        <div class="modal-body">					
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="${user.password}" name="password" type="password" class="form-control" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Role</label>
                                    <input value="${user.roleID}" name="role" type="text" class="form-control" required>
                                </div>
