    ...
    <body>
        <div id="logreg-forms">
            ...
            <form class="form-signin" action="login" method="post">
                ...
                <p class="text-danger">${errUser}</p>
                <p class="text-danger">${errPass}</p>
                <p class="text-danger">${errMail}</p>
                <p class="text-danger">${errDate}</p>
                <p class="text-danger">${errPhone}</p>
                <p class="text-center" style="color: blue">${successSU}</p>
                ...
                <div class="form-group form-check">
                    <input name="remember" value="${(cookie.cRem!=null?'checked':'')}" type="checkbox" class="form-check-input" id="exampleCheck1">
            ...
            <form action="signup" method="post" class="form-signup">
                ...
                <input name="birthday" type="text" id="birthday" class="form-control" placeholder="Birthday" required="" autofocus="">
                <input name="address" type="text" id="address" class="form-control" placeholder="Address" required="" autofocus="">
                <input name="phone" type="text" id="phone" class="form-control" placeholder="Phone Number" required="" autofocus="">
