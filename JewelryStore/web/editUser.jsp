                        ...
                        <form action="editUser" method="post">
                            ...
                            <div class="modal-body">					
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="${user.password}" name="password" type="password" class="form-control" readonly required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <c:if test="${user.roleID == 1}">
                                        <textarea name="role" class="form-control" required>Admin</textarea>
                                    </c:if>
                                    <c:if test="${user.roleID == 2}">
                                        <textarea name="role" class="form-control" required>User</textarea>
                                    </c:if>
                                </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="manageAccount" class="btn btn-info">Back</a>
                            </div>
                        </form>
                    </div>
                </div>
